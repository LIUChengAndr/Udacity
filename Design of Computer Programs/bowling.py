...
def make_score(balls, roll=0):
    if balls[roll] == 10:
        return 10 + balls[roll+1] + balls[roll+2]
    elif balls[roll] + balls[roll+1] == 10:
        return 10 + balls[roll+2]
    else: return balls[roll] + balls[roll+1]
